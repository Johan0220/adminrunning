...
import { loadOrderDetail, comfirmOrderFirst, cancelOrder } from "@/app/services/apiRequest";
function Order(props:any){ // properties  
    ...
    const comfirm = (id:number) => {
        comfirmOrderFirst(dispatch,tokenStr,id)
    }
                ...
                <td className="px-4 py-3 flex justify-center ">
                    ...
                    <div id={order.name} style={{display:actord?"block":"none"}} className="none right-2 absolute z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                        <ul className="py-1 text-sm" aria-labelledby={order.name}>
                            <li>
                                <button onClick={()=>{comfirm(order.id),setEditord(!editord)}} type="button" data-modal-target="updateorderModal" data-modal-add="updateorderModal" className="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                            ...
                            <li> 
                                ...
                                <svg aria-hidden="true"  xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 mr-1.5 -ml-1" viewBox="0 0 384 512"><path fill="currentColor" fillRule="evenodd" d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" clipRule="evenodd"/>
                                </svg>
                                    Cancel
                                </button>
                            </li>
                    ...
                    <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        ...
                        <div className="flex justify-between items-center pt-4">
                            <div className="flex items-center space-x-3 sm:space-x-4">
                                <button onClick={()=>{comfirm(order.id),setPreord(!preord)}} type="button" className="w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm  font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700  dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                <svg className="w-3.5 h-3.5 me-2 text-green-500 dark:text-green-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
                                </svg>
                                    Comfirm
                            ...
                            <button onClick={()=>{setPreord(!preord),setDelord(!delord)}} type="button" className="inline-flex items-center text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
                                <svg aria-hidden="true"  xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 mr-1.5 -ml-1" viewBox="0 0 384 512"><path fill="currentColor" fillRule="evenodd" d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" clipRule="evenodd"/>
                                </svg>
                                    Cancel
                            </button>
